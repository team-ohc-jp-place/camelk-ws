...
# Guide Provision
  oc -n infra new-app quay.io/jamesfalkner/workshopper --name=guides \
      ...
      -e S3_ACCESS_KEY="{{minio.access-key}}" \
      -e S3_SECRET_KEY="{{minio.secret-key}}" \
      -e S3_ENDPOINT="{{minio.endpoint}}" \
      -e CONTENT_URL_PREFIX="https://raw.githubusercontent.com/team-ohc-jp-place/camelk-ws/kaoto_v2" \
      -e WORKSHOPS_URLS="https://raw.githubusercontent.com/team-ohc-jp-place/camelk-ws/kaoto_v2/_camel-workshop-guides.yml" \
