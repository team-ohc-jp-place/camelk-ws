...
link:https://camel.apache.org/components/{{ CAMEL_VERSION }}/eips/split-eip.html[Split,window="_blank"]を使用して、Camel で Message を分割する方法について理解します。
...
前章の link:{{ HOSTNAME_SUFFIX }}/workshop/camel/lab/data-formats[DataFormatsパターン,window="_blank"]で 作成したインテグレーションを使用します。
