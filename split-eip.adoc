...
image::images/split/Sequencer.gif[pic]
...
image::images/split/04-split-001.png[pic,800]

続いて、`Routing` タブから `Split` を探して選択をしてください。
右上のテキストボックスに `Split` と入力をすると、絞り込みができます。

image::images/split/04-split-002.png[pic,800]
...
image::images/split/04-split-003.png[pic,1200]
...
image::images/split/04-split-004.png[pic,1200]

これで、`Split` で分割した後のMessageの内容が表示されます。

image::images/split/04-split-005.png[pic,800]
...
image::images/split/04-split-006.png[pic,1200]
...
image::images/split/04-split-007.png[pic,1200]
...
image::images/split/04-split-008.png[pic,1200]
