...
link:https://debezium.io/[Debezium,window="_blank"] は **Kafka Connect** の仕組みを使用したチェンジデータキャプチャの基盤となる製品です。
...
image::dbsync/11-dbsync-007.png[width="1200px"]
...
image::dbsync/11-dbsync-014.png[width="800px"]
...
image::dbsync/11-dbsync-015.png[width="1200px"]
...
image::dbsync/11-dbsync-016.png[width="1200px"]
...
link:https://camel.apache.org/components/{{ CAMEL_VERSION }}/eips/choice-eip.html[Choice^]
...
image::dbsync/11-dbsync-017.png[width="800px"]

Log の下に、Choice コンポーネントが配置されます。

image::dbsync/11-dbsync-018.png[width="1200px"]
...
image::dbsync/11-dbsync-020.png[width="800px"]
...
image::dbsync/11-dbsync-021.png[width="1200px"]
...
image::dbsync/11-dbsync-013.png[width="1200px"]
...
image::dbsync/11-dbsync-022.png[width="600px"]
...
image::dbsync/11-dbsync-023.png[width="1200px"]
...
image::dbsync/11-dbsync-024.png[width="1200px"]
...
image::dbsync/11-dbsync-025.png[width="800px"]
...
image::dbsync/11-dbsync-026.png[width="1200px"]
...
image::dbsync/11-dbsync-027.png[width="800px"]
...
image::dbsync/11-dbsync-028.png[width="1200px"]
...
image::dbsync/11-dbsync-029.png[width="800px"]

Logの確認後、`Ctrl+C` もしくは、ターミナル右上のゴミ箱のアイコンをクリックして、終了してください。

参考リンク

* https://access.redhat.com/documentation/en-us/red_hat_build_of_debezium[Red Hat build of Debezium^]